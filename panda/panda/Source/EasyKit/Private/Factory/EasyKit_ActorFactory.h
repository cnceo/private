//
// EasyKit_ActorFactory.h
//
// Actor工场 用于加载.uasste 资源 并实例化资源
//
...
#include "EasyKit_ActorFactory.generated.h"

/**
 * 
 */
UCLASS(hidecategories = Object, editinlinenew, config = EasyKit, abstract, transient)
class EASYKIT_API UEasyKit_ActorFactory : public UObject
{
