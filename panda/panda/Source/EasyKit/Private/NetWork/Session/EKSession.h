...
#include "EKSession.generated.h"

struct FEKSessionParams
{
...
UCLASS(config=Game)
class EASYKIT_API AEKSession : public AGameSession
{
...
protected:
	...
	FEKSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FEKOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FEKOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(AEKSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(AEKSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(AEKSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(AEKSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
